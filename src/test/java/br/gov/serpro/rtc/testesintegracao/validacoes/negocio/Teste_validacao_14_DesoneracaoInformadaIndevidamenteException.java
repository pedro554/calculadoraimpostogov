...
@Disabled
class Teste_validacao_14_DesoneracaoInformadaIndevidamenteException {
    ...
    @BeforeEach
    void beforeEach(final @Value("classpath:entradas/validacoes/Teste_validacao_14_DesoneracaoInformadaIndevidamenteException.json") Resource resourceFile)
            throws Exception {
    ...
    void teste_service_CalcularTributos() {
        assertThatThrownBy(() -> calculadoraService.calcularTributos(operacao))
                .isExactlyInstanceOf(DesoneracaoInformadaIndevidamenteException.class);
    }
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("Grupo de desoneração informado indevidamente"));
    }
